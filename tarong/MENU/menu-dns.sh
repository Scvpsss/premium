...
APIGIT=$(cat /etc/kuhing/github/api)
EMAILGIT=$(cat /etc/kuhing/github/email)
USERGIT=$(cat /etc/kuhing/github/username)
...
function check-dns(){
    bash <(curl -sSL https://raw.githubusercontent.com/Scvpsss/premium/main/FILE/MENU/ceknet.sh)
read -n 1 -s -r -p "   Press any key to back on menu"
menu
}
