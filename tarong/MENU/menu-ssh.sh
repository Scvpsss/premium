...
if [[ -e /usr/bin/m-udp ]]; then
echo -e " SUDAH INSTALL SSH UDP "
read -n 1 -s -r -p "Press any key to back on menu"
m-sshovpn
...
wget https://raw.githubusercontent.com/casper9/perv1/main/install/insudp.sh &&  chmod +x insudp.sh && ./insudp.sh
