...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/Scvpsss/izin/main/vps | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e ""
echo -e " [\e[36m•1\e[0m] MENU BOT"
echo -e " [\e[36m•2\e[0m] MENU UPDATE"
echo -e ""
